  ...
  <div class="container-full" id="login-box">
    <div class="left-box">
      <div class="welcome-section">
          ...
          <p class="signIn mt-5">Already have an account sign in <a href="<?= base_url()?>index.php/teacher/login">Here</a></p>
      </div>
    </div>
  </div>
  <div class="right-box align-items-center">
    <div class="login-container d-flex align-items-center justify-content-center">
      <form class="signup-form text-center" action="" method="post">
            ...
            <h1 class="mb-3">TEACHER SIGN-UP</h1>
        ...
        <div class="form-group">
            <textarea name="bio" class="form-control form-control-sm" placeholder="Education" rows="1" required></textarea>
        </div>
